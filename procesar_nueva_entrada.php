...
<?php
		...
		try {
			   ...
			   $conexion->query("insert into Entrada(codHilo,descripcion,username,dia,mes,anio,hora,minuto)
													values('$codHilo','$descripcion','$username','$dia','$mes','$anio','$hora','$minuto');");

				 header("Location: foro.php");

				 $conexion = "";

		} catch ( PDOException $e ) { echo "<h1 id=\"problema\">Problema al crear una nueva entrada</h1>"; }
